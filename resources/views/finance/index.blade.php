...
<div class="dashboard-card">
    ...
    {{-- ══════════════════════════════════════════════════════════════
     TOP BAR — dynamic title + dynamic top buttons
    ═══════════════════════════════════════════════════════════════ --}}
    <div class="d-flex align-items-start justify-content-between mb-3">
        ...
        {{-- Dynamic top-right buttons per tab --}}
        <div class="d-flex flex-column gap-1 align-items-end">
    
            {{-- Quotation tab buttons --}}
    ...
    {{-- ══════════════════════════════════════════════════════════════
        FINANCE TABS — Quotation | Invoice | Payment
    ═══════════════════════════════════════════════════════════════ --}}
    <div class="finance-tabs mb-0" id="financeTabs">
        <button class="fin-tab" id="tab-btn-quotation" data-tab="quotation">
            <i class="bi bi-file-text me-1"></i> Quotation
        </button>
        <button class="fin-tab" id="tab-btn-invoice" data-tab="invoice">
            <i class="bi bi-receipt me-1"></i> Invoice
        </button>
        <button class="fin-tab" id="tab-btn-payment" data-tab="payment">
    ...
    {{-- ══════════════════════════════════════════════════════════════
     TAB PANEL 1 — QUOTATION (Subject_Fee)
    ═══════════════════════════════════════════════════════════════ --}}
    <div class="fin-tab-panel" id="panel-quotation" style="display:none;">
        <div class="richbox richbox-fullwidth" id="quotationBox">
            <div class="richbox-header">
                <i class="bi bi-file-text me-1"></i> Quotation Records
                <span class="ms-2 badge bg-secondary fw-normal tab-row-count" style="font-size:10px;">0</span>
            ...
            <div class="richbox-body" style="max-height: calc(100vh - 360px);">
                <table class="richbox-table" id="quotationTable">
                    ...
                    <tbody id="quotationBody">
                        ...
                        <tr class="fin-row" data-tab="quotation" data-id="{{ $q->Quotation_ID }}"
                        ...
                        <tr class="fin-row" data-tab="quotation" data-id="QT-2024-001"
                            ...
                            data-name="Andi Pratama" data-instalment="SPP Semester 1" data-idate="2024-01-01">
                        ...
                        <tr class="fin-row" data-tab="quotation" data-id="QT-2024-002"
                            ...
                            data-name="Budi Santoso" data-instalment="Biaya Buku Paket" data-idate="2024-02-15">
                        ...
                        <tr class="fin-row" data-tab="quotation" data-id="QT-2024-003"
                            ...
                            data-name="Citra Dewi" data-instalment="UTS Semester 1" data-idate="2024-03-20">
    ...
    <div class="fin-tab-panel" id="panel-payment" style="display:none;">
        <div class="richbox richbox-fullwidth" id="paymentBox">
            <div class="richbox-header">
                ...
                <table class="richbox-table" id="paymentTable">
                    ...
                    <tbody id="paymentBody">
                        ...
                        <tr class="fin-row" data-tab="payment" data-id="INV-2024-0003"
                            data-method="Transfer" data-deposit="" data-card="Visa"
    ...
    {{-- ══════════════════════════════════════════════════════════════
        ACTION BUTTONS — dynamic per active tab
    ═══════════════════════════════════════════════════════════════ --}}
        ...
        <div class="modal-content" style="border-radius:8px; overflow:hidden;">
            ...
            <div class="modal-body p-0">
                <div id="receiptArea" style="padding:28px 36px; background:#fff;">
                    ...
                    {{-- Dynamic field grid --}}
                    <div id="receiptFields" style="font-size:13px;" class="mb-3">
                        {{-- Populated by JS --}}
                    </div>
            ...
            <div class="modal-footer" style="background:#f8f9fa; border-top:1px solid #e0e0e0; padding:8px 16px;">
                <small class="text-muted me-auto" style="font-size:11px;">
                    <i class="bi bi-info-circle me-1"></i>
                    Payment breakdown detail will be available once DB is connected.
                </small>
